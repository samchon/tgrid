...
If you're not familiar with theoretical stories, it's okay to skip to the next chapter [Features > WebSocket Protocol](./websocket).

Even you want to see the example codes, step to the [Learn from Examples > Remote Function Call](../examples/remote-function-call) chapter.
